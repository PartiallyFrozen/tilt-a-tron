...
/* TILT-A-TRON: the tables are const (rodata) and copied into PSRAM by Info_Init: nightmare
   and -fast change them, and 40 KB of internal RAM is too much to spend here */
...
// TILT-A-TRON: working copies of the tables, in PSRAM. Call before anything else.
#include <stdlib.h>
#include <string.h>
